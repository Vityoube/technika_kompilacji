...
static const char *const yytname[] =
{
  ...
  "NEW_BLOCK", "PROC_CALL_WITH_ARGUMENTS", "FUNCTION_CALL", "MOV", "MULI",
  "MULR", "DIVI", "DIVR", "MOD", "ANDI", "ANDR", "INT_TO_REAL",
  "REAL_TO_INT", "ORI", "ORR", "ADDI", "ADDR", "SUBI", "SUBR", "','",
  ...
  "arguments", "parameter_list", "compound_statement", "begin",
  "optional_statements", "statement_list", "statement", "If", "Then",
  "Else", "While", "Do", "variable", "procedure_statement",
  "expression_list", "expression", "simple_expression", "or", "term",
  "factor", YY_NULLPTR
};
#endif
...
{
      -9,     9,    34,     2,   -90,    32,   -90,    22,     5,    50,
      78,   -90,   -90,    73,    32,    46,   -21,   -90,    82,    83,
      60,   -90,    63,    66,    61,    64,    64,   -90,    14,   -90,
      -7,   -90,   -90,   -90,    80,    67,   -90,    42,    42,    71,
     -90,    59,   -90,   -90,    68,   -90,    32,    65,    70,    32,
     -90,    42,    42,   -90,    66,   -90,   -12,    49,    49,    42,
     -90,    92,    29,    76,   -90,    93,    42,    98,   -90,   -15,
      30,    55,   -90,   -11,   -19,   -90,    72,   -90,    42,   -90,
      76,    77,   -90,    66,   -90,    49,    42,    49,    49,   -90,
      66,   -90,    79,    61,   -90,    32,    81,    61,   -90,    42,
     -90,   -18,   -90,    97,    76,    62,    76,   -90,   -90,    84,
     -90,   -10,   -90,    86,   -90,   -90,   -90,    66,   103,    61,
     -90,   -90,    85,   -90,    90,    55,   -90
};
...
static const yytype_uint8 yydefact[] =
{
       ...
       0,     8,     0,    26,     0,    19,    19,    15,     0,     2,
      41,    34,    37,    31,     0,    25,    27,     0,     0,     0,
      30,     0,    12,    13,     0,    10,     0,     0,     0,     0,
      16,     0,     0,    23,     0,    56,    39,     0,     0,     0,
      54,     0,    45,    47,    52,     0,     0,     0,     6,     0,
       0,     0,    18,     0,     0,    43,     0,    28,     0,    58,
      48,     0,    35,     0,    51,     0,     0,     0,     0,    38,
       0,    29,     0,     0,    20,     0,     0,     0,    42,     0,
      40,     0,    57,     0,    49,    46,    50,    53,    33,     0,
      21,     0,    17,     0,    44,    55,    36,     0,     0,     0,
       9,    32,     0,    22,     0,     0,    11
};
...
{
     -90,   -90,   -90,   -13,   -90,   -90,   -89,   -69,   -90,   -90,
     -90,    87,   -90,    -2,   -90,   -90,   -90,   -51,   -90,   -90,
     -90,   -90,   -90,   -23,   -90,    33,   -31,    26,   -90,   -42,
     -46
};
...
{
      -1,     2,     7,     8,    13,    28,    44,    45,    15,    20,
      21,    47,    70,    33,    23,    34,    35,    36,    37,    83,
     117,    38,    90,    60,    40,    74,    75,    62,    87,    63,
      64
};
...
{
      39,    16,    96,    77,   110,     1,    61,    65,   113,    98,
     115,    79,    24,    22,     3,    78,    80,   -39,    93,    52,
      51,    76,    97,   119,    52,    17,    50,    49,    81,     5,
     123,    39,   103,    69,     4,    91,    73,     6,    10,   108,
      99,    99,   107,   104,    10,   106,    55,    56,    10,    10,
       9,    84,    85,    55,    56,    86,   126,    17,    94,    95,
      39,    18,    19,    57,    10,    58,   121,    39,   114,    59,
      57,    30,    31,    32,    42,    43,    59,    17,    41,    11,
      42,    43,   111,    12,    84,    85,    14,    25,    26,    27,
      67,    46,    53,    29,    39,    66,    54,    68,    71,    72,
      82,    88,    92,    89,   100,   102,   116,   122,   125,   109,
     112,   101,   105,    48,   118,   120,     0,   124
};

static const yytype_int8 yycheck[] =
{
      23,    14,    71,    54,    93,    14,    37,    38,    97,    28,
      28,    57,    33,    15,     5,    27,    58,    24,    33,    31,
      27,    52,    33,    33,    31,    11,    28,    13,    59,    27,
     119,    54,    83,    46,     0,    66,    49,     5,    59,    90,
      59,    59,    88,    85,    59,    87,     4,     5,    59,    59,
      28,    22,    23,     4,     5,    26,   125,    11,    28,    29,
      83,    15,    16,    21,    59,    23,   117,    90,    99,    27,
      21,     5,     6,     7,    19,    20,    27,    11,    17,    29,
      19,    20,    95,     5,    22,    23,    13,     5,     5,    29,
      31,    27,    12,    30,   117,    24,    29,    29,    33,    29,
       8,    25,     4,    10,    32,    28,     9,     4,    18,    30,
      29,    78,    86,    26,    30,    29,    -1,    32
};
...
{
       0,    14,    61,     5,     0,    27,     5,    62,    63,    28,
      59,    29,     5,    64,    13,    68,    63,    11,    15,    16,
      69,    70,    73,    74,    33,     5,     5,    29,    65,    30,
       5,     6,     7,    73,    75,    76,    77,    78,    81,    83,
      84,    17,    19,    20,    66,    67,    27,    71,    71,    13,
      73,    27,    31,    12,    29,     4,     5,    21,    23,    27,
      83,    86,    87,    89,    90,    86,    24,    31,    29,    63,
      72,    33,    29,    63,    85,    86,    86,    77,    27,    90,
      89,    86,     8,    79,    22,    23,    26,    88,    25,    10,
      82,    86,     4,    33,    28,    29,    67,    33,    28,    59,
      32,    85,    28,    77,    89,    87,    89,    90,    77,    30,
      66,    63,    29,    66,    86,    28,     9,    80,    30,    33,
      29,    77,     4,    66,    32,    18,    67
};
...
#line 294 "parser.yy" /* yacc.c:1646  */
    {
                                                      ...
                                                      type.standard_type=(yyvsp[0].standard_type);
                                                      type.is_array=true;
                                                      struct Number first_index_NUM=(yyvsp[-6].number);
...
#line 570 "parser.yy" /* yacc.c:1646  */
    {
                                    ...
                                    switch(array_index.token_type){
                                      ...
                                      if (array_index.is_array_data_type)
                                        ...
                                        (yyval.entry)->current_array_index=array_index.values.at(0).integer;
                                        break;
                                      case VALUE:
                                        if (array_index.values.at(0).integer<0 || array_index.values.at(0).integer>(yyval.entry->last_index))
                                          yyerror("Array out of bounds.");
...
#line 609 "parser.yy" /* yacc.c:1646  */
    {
                           ...
                           (yyval.entry)=new Entry(entries_list.at(procedure_index));
                           struct Procedure procedure;
                           procedure.name=(yyvsp[0].name);
...
#line 671 "parser.yy" /* yacc.c:1646  */
    {
                                                          ...
                                                          relop_value.data_type=(yyval.entry)->data_type;
                              ...
                              if (entry1.data_type==INT_TYPE){
                                ...
                                if (((yyvsp[-1].name))->compare("*")==0){
                                  ...
                                  if (entry1.values.at(0).integer==0 || entry2.values.at(0).integer==0)
                                        ...
                                        (yyval.entry)->values.at(0).integer==1;
                                    yylval.mulop.result=(yyval.entry);
                                   ...
                                   if (((yyvsp[-1].name))->compare("*")==0){
                                     ...
                                     if (entry1.values.at(0).real==0.0 || entry2.values.at(0).real==0.0)
                                           ...
                                           (yyval.entry)->values.at(0).real==1.0;
                                       yylval.mulop.result=(yyval.entry);
